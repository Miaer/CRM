...
<%--<div class="article toolbar">
    ...
    <div class="content">
    	<ul class="toollist ue-clear">
    		<li>
            	<a href="work.html" class="img" target="right"><img src="/images/icon01.png" /></a>
                <p><a href="work.html" target="right">工作日志</a></p>
            </li>
            <li>
            	<a href="email.html" class="img" target="right"><img src="/images/email03.png" /></a>
                <p><a href="email.html" target="right">邮箱</a></p>
            </li>
            <li>
            	<a href="mailList.html" class="img" target="right"><img src="/images/icon02.png" /></a>
                <p><a href="mailList.html" target="right">通讯录</a></p>
            </li>
            <li>
            	<a href="schedule.html" class="img" target="right"><img src="/images/icon04.png" /></a>
                <p><a href="schedule.html" target="right">日程安排</a></p>
            </li>
            <li>
            ...
            <li>
            	<a href="leave.html" class="img"><img src="/images/leave01.png" /></a>
                <p><a href="leave.html">请假申请</a></p>
            </li>
            <li>
            	<a href="fcontract_sign.html" class="img" target="right"><img src="/images/posintion01.png" /></a>
                <p><a href="fcontract_sign.html" target="right">项目合同会签</a></p>
            </li>
            <li>
            	<a href="file_sign.html" class="img" target="right"><img src="/images/file02.png" /></a>
                <p><a href="file_sign.html" target="right">文件会签</a></p>
            </li>
            <li>
            	<a href="document_wait.html" class="img" target="right"><img src="/images/file03.png" /></a>
                <p><a href="document_wait.html" target="right">公文办理</a></p>
            </li>
            <li>
                <a href="recode.html" class="img" target="right"><img src="/images/icon07.png" /></a>
                <p><a href="recode.html" target="right">定制任务</a></p>
            </li>
            <li>
                <a href="dossier_my.html" class="img" target="right"><img src="/images/myFiles.png" /></a>
                <p><a href="dossier_my.html" target="right">个人档案</a></p>
            </li>
            <li class="add-btn">
