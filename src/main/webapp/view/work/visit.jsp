...
<div class="title"><h2>拜访记录</h2></div>
<div class="query">
    <div class="tabe_bot">
        <div class="l_left"><label>客户：</label><input type="text" id="company_name" placeholder="请输入客户姓名"></div>
        <%--<div class="l_left"><label>发布人：</label><input type="text" placeholder="请输入姓名"></div>--%>
        <div class="l_left"><label>完成时间：</label><input id="visit_complete_time" placeholder="输入年月" /></div>
...
<script>
    !function(){
        ...
        laydate({elem: '#visit_complete_time'});//绑定元素
    }();
</script>
<script src="/js/layer_v2.1/layer/layer.js"></script>
